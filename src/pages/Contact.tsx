  ...
  return (
    <div className="flex flex-col items-center">
      <section className="w-full max-w-3xl mx-auto px-4 pt-20 md:pt-32 pb-24 relative z-10">
        <div className="hidden md:block absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] bg-emerald-500/15 blur-[120px] rounded-full pointer-events-none -z-10"></div>
        ...
        <div className="space-y-4">
          {contacts.map((item, i) => (
            <motion.a
              ...
              className="group flex items-start gap-6 p-8 rounded-3xl bg-zinc-900/40 border border-white/5 hover:border-emerald-500/30 hover:bg-zinc-900/60 transition-all duration-300 md:backdrop-blur-sm"
            >
              <div className="w-12 h-12 rounded-xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center border border-emerald-500/20 group-hover:scale-110 group-hover:bg-emerald-500/20 transition-all duration-300 flex-shrink-0">
                {item.icon}
              </div>
