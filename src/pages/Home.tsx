...
import { isMobile, fadeInView } from '../lib/motion';
    ...
    <div className="flex flex-col items-center">
      ...
      <section className="w-full max-w-5xl mx-auto px-4 pt-20 md:pt-32 pb-16 md:pb-24 text-center relative">
        ...
        >
          ...
          <Link to="/pricing" className="w-full sm:w-auto bg-zinc-900/80 text-white border border-white/10 px-8 py-3.5 rounded-full hover:bg-zinc-800 hover:text-white hover:border-white/20 transition-all font-semibold flex items-center justify-center md:backdrop-blur-md">
            View Pricing
          </Link>
        </div>
      </section>
      ...
      {/* Stats Bar */}
      <section className="w-full border-y border-white/5 bg-zinc-900/60 md:bg-zinc-900/20 md:backdrop-blur-xl py-12 relative z-10">
      ...
      {/* Social Proof */}
      <section className="w-full border-y border-white/5 bg-zinc-900/60 md:bg-zinc-900/20 md:backdrop-blur-xl py-24 relative z-10">
        <motion.div
          {...fadeInView(30, 0.5)}
      ...
      <section className="w-full max-w-5xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            <motion.div
              key={t.name}
              {...fadeInView(16, 0.35, i * 0.07)}
              className="p-8 rounded-3xl bg-zinc-900/40 border border-white/5 md:backdrop-blur-sm flex flex-col gap-4 relative z-10"
            >
      ...
      <section id="comparison" className="w-full max-w-5xl mx-auto px-4 py-16 md:py-24">
        ...
        <motion.div
          {...fadeInView(30, 0.6, 0.15)}
          className="overflow-x-auto rounded-3xl border border-white/5 md:backdrop-blur-xl relative z-10"
        >
