    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/5 bg-zinc-950/60 backdrop-blur-xl">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6 text-sm font-medium text-zinc-400">
          ...
          <Link to="/joke" className="hover:text-white transition-colors">Log in</Link>
          <Link to="/joke" className="bg-white text-zinc-950 px-5 py-2.5 rounded-full hover:bg-zinc-200 transition-all font-semibold hover:scale-105 shadow-[0_0_20px_-5px_rgba(255,255,255,0.3)]">
            Get Started
          </Link>
        </div>
      </div>
